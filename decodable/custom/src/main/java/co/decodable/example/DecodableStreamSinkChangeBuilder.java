...
public class DecodableStreamSinkChangeBuilder<T> implements DecodableStreamSinkBuilder<T> {

  private String streamId;
  private String streamName;
  private SerializationSchema<T> serializationSchema;
  private SerializationSchema<T> keySerializationSchema;

  @Override
  public DecodableStreamSinkChangeBuilder<T> withStreamName(String streamName) {
  ...
  @Override
  @Deprecated
  public DecodableStreamSinkChangeBuilder<T> withStreamId(String streamId) {
    this.streamId = streamId;
    return this;
  }

  @Override
  public DecodableStreamSinkChangeBuilder<T> withSerializationSchema(
      SerializationSchema<T> serializationSchema) {
    this.serializationSchema = serializationSchema;
    return this;
  }

  public DecodableStreamSinkChangeBuilder<T> withKeySerializationSchema(
